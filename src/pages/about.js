  ...
  return(
    <Layout  title={siteTitle}>
      <div className="outer-page-wrap">
        ...
        <p>Once in a while, he gets me out of my boring mundane workaholic life and we travel to the capital city to see some cool concert. Just recently it was a Paul Gilbert concert. I still can't quite recover from that.</p>
